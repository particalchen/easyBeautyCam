...
**最新**：〇十 iOS 端改用 Apple Vision framework（修 iOS sim arm64 不兼容，详见 [〇十](#vision-framework-replacement-2026-06-23)）

**上一节**：〇九 人脸识别美颜（ML Kit，按 mask 只磨人脸区域，详见 [〇九](#face-detection-beauty-2026-06-23)）
